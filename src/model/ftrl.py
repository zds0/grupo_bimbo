...
train = os.path.join(data_dir, 'raw', 'train.csv')
test = os.path.join(data_dir, 'raw', 'test.csv')
submission = os.path.join(data_dir, '..', 'models', 'submissions', 'ftrl.csv')
